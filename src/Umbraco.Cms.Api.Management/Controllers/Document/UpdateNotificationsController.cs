...
public class UpdateNotificationsController : DocumentControllerBase
{
    ...
    [EndpointSummary("Updates notifications for a document.")]
    [EndpointDescription("Updates the notification settings for a document identified by the provided Id, allowing users to subscribe/unsubscribe to specific notification actions.")]
